#!/usr/bin/env python3
"""Build the social preview card for the SAIR SAIR Foundation Index repository.
...
MARK = Path(__file__).resolve().parent.parent.parent / "assets" / "sair-mark-flat.png"

TITLE = "SAIR Foundation"
SUBTITLE = "Competition archive and research index"
KEYWORDS = "every challenge · one index"
FOOTER = "SAIR Foundation · CC BY 4.0 · github.com/Amey-Thakur"
